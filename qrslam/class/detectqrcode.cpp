...
ofstream fCalc_info("Calc_info.txt"); //采集mark的解析值
    ...
    //     p_tracker_marks_->setThreshold(tryCount);
        ...
        for (int i = 0 ; i < nNumMarkers ; i++)
        {
            ...
            if ( (nMarker_info[i].id != -1) && (ht_[nMarker_info[i].id] > 0.1) )
            {
                ...
                fCalc_info<<" area cf dir id line pos vertex "<<endl;
                cout<<"nMarker_info[i].id "<<nMarker_info[i].id<<endl;
                ...
                for (int ii = 0 ; ii < detectedID.size(); ii++)
                {
                    fCalc_info<<" "<<Mark_info.area<<" "<<Mark_info.cf<<" "<<Mark_info.dir
                             <<" "<<Mark_info.id<<" "<<endl;

                    fCalc_info<<" "<<Mark_info.line[(4-Mark_info.dir+0)%4][0]<<" "<<Mark_info.line[(4-Mark_info.dir+0)%4][1]<<" "<<Mark_info.line[(4-Mark_info.dir+0)%4][2]
                    ...
                    fCalc_info<<" "<<Mark_info.pos[0]<<" "<<Mark_info.pos[1]<<endl;

                    fCalc_info<<" "<<Mark_info.vertex[(4-Mark_info.dir+0)%4][0]<<" "<<Mark_info.vertex[(4-Mark_info.dir+0)%4][1]
